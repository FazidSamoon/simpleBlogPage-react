...
import {loginWIthEmailPassword , signInwithGmail , useAuth} from "../Utils/firebase"
...
function LoginPage() {
    ...
    const currentUser = useAuth(); //track of the current user properties
  ...
  return (
    <Container>
        <LoginForm>
            <h1>Login</h1>
            <LoginWithGmail onClick={handleLoginWithGmail}>
